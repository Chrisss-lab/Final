...
function Contact() {
  return (
    ...
    >
      ...
      <p style={{ fontSize: "1.2em", maxWidth: "600px", marginBottom: "20px" }}>
        Or please text us at{" "}
        <a
      ...
      <p style={{ fontSize: "1.1em", maxWidth: "600px", marginTop: "10px", color: "#555" }}>
        If you want to make a <strong>custom order</strong> or have <strong>special dietary restrictions</strong>, just let us know! 
        We love creating personalized blends for your furry friend.
      </p>
      <div
        style={{
          marginTop: "30px",
