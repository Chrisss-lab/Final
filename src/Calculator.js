...
export default function Calculator() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", padding: "20px", backgroundColor: "#f7fafc", minHeight: "100vh" }}>
      <div style={{ maxWidth: "480px", margin: "0 auto", backgroundColor: "#fff", borderRadius: "16px", padding: "20px", boxShadow: "0 10px 25px rgba(0,0,0,0.1)" }}>
