...
import MeatFlowers from "./Photos/Meat Flowers.jpg";
  ...
  return (
    <Router>
      ...
      <div style={{ fontFamily: "Arial, sans-serif", color: "#333", backgroundColor: "#f4f6f8", minHeight: "100vh" }}>
        ...
        {/* ROUTES */}
        <Routes>
          <Route path="/" element={<div style={{ textAlign: "center" }}> {/* HERO + WHY CHOOSE sections */} </div>} />
        ...
        {/* Keep your existing Google Map, FB feed, and footer JSX here */}
      </div>
    </Router>
  );
}
